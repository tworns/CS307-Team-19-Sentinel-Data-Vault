			...
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					...
					if (index == 1) {
						...
						btnSave.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								DataEntry newEntry = new DataEntry(textField.getText(),"Credit/Debit Card",null,null,0,null);
								newEntry.addDataField(textField_1.getText());
					...
					if (index == 2) {
						...
						btnSave.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								//TODO: Add Entry to data base
								DataEntry newEntry = new DataEntry(textField.getText(),"PassPort",null,null,0,null);
								newEntry.addDataField(textField_1.getText());
								newEntry.addDataField(textField_2.getText());
								newEntry.addDataField(textField_3.getText());
								newEntry.addDataField(textField_4.getText());
					...
					if (index == 3) {
						...
						btnSave.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								DataEntry newEntry = new DataEntry(textField.getText(),"Driver's license",null,null,0,null);
								newEntry.addDataField(textField_1.getText());
								newEntry.addDataField(textField_2.getText());
								newEntry.addDataField(textField_3.getText());
								newEntry.addDataField(textField_4.getText());
					...
					if (index == 4) {
						...
						btnSave.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								DataEntry newEntry = new DataEntry(textField.getText(),"Website Login",null,null,0,null);
								newEntry.addDataField(textField_1.getText());
								newEntry.addDataField(textField_2.getText());
								newEntry.addDataField(textField_3.getText());
								DatabaseManager m = new DatabaseManager();
					...
					if (index == 5) {
						...
						btnSave.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								//TODO: Add Entry to data base
								DataEntry newEntry = new DataEntry(textField.getText(),"Wifi Network",null,null,0,null);
								newEntry.addDataField(textField_1.getText());
								newEntry.addDataField(textField_2.getText());
								newEntry.addDataField(textField_3.getText());
								DatabaseManager m = new DatabaseManager();
					...
					if (index == 6) {
						...
						btnSave.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								DataEntry newEntry = new DataEntry(textField.getText(),"Phone Number",null,null,0,null);
								newEntry.addDataField(textField_1.getText());
								newEntry.addDataField(textField_2.getText());
								newEntry.addDataField(textField_3.getText());
								DatabaseManager m = new DatabaseManager();
